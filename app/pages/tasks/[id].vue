        ...
        <div v-else-if="task">
            ...
            <div class="mb-6">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <UButton v-if="isCreator" color="error" variant="soft" class="ml-auto" @click="deleteTask">
                        ...
                        <template #header>
                            <div class="flex items-center justify-between">
                                ...
                                <UButton icon="i-heroicons-plus" size="sm" color="primary" variant="soft"
                                    @click="openTimeEntryModal" v-if="isAssignee">
                                    Add Time Entry
                                </UButton>
                            </div>
                        </template>
                ...
                <div class="lg:col-span-1 space-y-4">
                    ...
                    <UCard v-if="task.type === 'TASK'">
                        ...
                        <div class="space-y-3">
                            ...
                            <UButton v-if="isAssignee" :color="task.isDone ? 'info' : 'primary'" block variant="ghost"
                    ...
                    <UCard>
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Assignee -->
                            <div v-if="task.type === 'TASK'" @click="openAssigneeModal" class="cursor-pointer"
                                ...
                                <div
                                    ...
                                    <UAvatar :src="task.assignee?.image || undefined"
                                        :alt="task.assignee?.name || 'User'" size="sm" />
                                    <div class="flex-1 min-w-0">
                                        <p class="font-medium text-sm text-gray-900 dark:text-white truncate">{{
