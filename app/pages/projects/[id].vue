    ...
    <div v-else-if="project" class="space-y-6">
      ...
      <div class="flex items-start justify-between">
        <div class="flex items-center gap-3">
          ...
          <UBadge
            v-for="label in statusLables"
            :key="label"
            :color="statusColorsMap[label]"
            variant="soft"
            size="lg"
          >
            {{ label }}
      ...
      <UCard>
        ...
        <div
          class="grid grid-cols-1 md:grid-cols-2 [.has-end-date]:md:grid-cols-3 gap-6"
      ...
      <UCard>
        ...
        <div
          v-if="project.userProjects.length > 0"
          class="divide-y divide-gray-200 dark:divide-gray-800"
        >
          <div
            v-for="userProject in project.userProjects"
            :key="userProject.userId"
            class="py-4 first:pt-0 last:pb-0"
          >
            <div class="flex items-center gap-4">
              <UAvatar
                :src="userProject.user.image || undefined"
              ...
              <UButton
                v-if="isOwner && userProject.user.id !== project.ownerId"
                size="sm"
                color="error"
                variant="ghost"
                class="rounded-full"
                @click="removeParticipant(userProject.user.id)"
              >
      ...
      <UCard>
        ...
        >
          <div
            v-for="task in project.tasks.filter((task) => task.type === 'TASK')"
            :key="task.id"
            class="py-4 first:pt-0 last:pb-0"
          >
            <NuxtLink
