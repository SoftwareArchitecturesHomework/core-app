...
<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-900 dark:to-gray-800">
    <UCard class="w-full max-w-md shadow-xl">
      <template #header>
        <div class="text-center space-y-2">
          <h1 class="text-3xl font-bold text-primary-600 dark:text-primary-400">WorkPlanner</h1>
      ...
      <div class="space-y-6 py-6">
        <div class="text-center space-y-2">
          ...
          <p class="text-gray-600 dark:text-gray-400">
            Welcome back! Sign in to access your projects and calendar.
          </p>
        </div>

        <UDivider label="Continue with" />
