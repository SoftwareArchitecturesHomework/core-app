...
<template>
  <div class="p-6 max-w-4xl mx-auto">
    <h1 class="text-4xl font-bold text-center text-primary-600 mb-6"
      >Manager Reports</h1
    >
    ...
    <UCard class="mb-8">
      <div class="text-center py-4">
        ...
        <p class="text-lg font-semibold text-gray-800 dark:text-gray-200">
          Here you can download and open the latest report in HTML and PDF
          format.
        </p>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">
          Monthly reports will be generated and distributed via email after the
          closed month.
        </p>
      </div>
    </UCard>
    ...
    <UCard
      v-else-if="error"
      class="bg-red-50 dark:bg-red-900/20 border-red-400"
    >
    ...
    <UCard v-else>
      <p class="text-center text-gray-500"
        >No current manager report available.</p
      >
    </UCard>
  </div>
</template>
