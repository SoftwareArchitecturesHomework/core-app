...
<template>
    <div class="p-6 max-w-7xl mx-auto">
        <div class="mb-8">
            ...
            <div v-if="vacationRequests && vacationRequests.length > 0" class="space-y-4">
                <VacationRequestCard v-for="request in vacationRequests" :key="request.id" :vacationRequest="request"
